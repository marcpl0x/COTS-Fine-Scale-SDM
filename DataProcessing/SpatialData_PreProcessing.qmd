...
turb <- terra::rast("C:/Users/user/OneDrive - James Cook University/CCIP-BR-13-MarcKoh/CCIP-BR-13-MarcKoh/MarcData/GBR Turbidity data/Turbidity-2024/turbidity-annual_0.tif")
crs(turb)

if (crs(turb) != crs(coralSDM.Ahya)) {
  message("Reprojecting reef polygons to raster CRS...")
  turb <- terra::project(turb, crs(coralSDM.Ahya))
}
...
Only 2024 Turbidity Data Available from Allen Coral Atlas
...
reef_poly <- terra::vect("C:/Users/user/OneDrive - James Cook University/CCIP-BR-13-MarcKoh/CCIP-BR-13-MarcKoh/MarcData/Great_Barrier_Reef_Features.gpkg") |>
  filter(FEAT_NAME=="Reef") # <:changed filepath to suit me 
...
#  },
#  packages = c("terra", "raster", "Matrix"))
toc() # took about 8 seconds with the plan() function
